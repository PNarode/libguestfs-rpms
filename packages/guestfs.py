...
class GuestFS(object):
    ...
    def add_drive(self, filename, readonly=None, format=None, iface=None,
        ...
        If not given, then no authentication is attempted
        for ceph. But note this sometimes may give
        unexpected results, for example if using the libvirt
        backend and if the libvirt backend is configured to
        start the qemu appliance as a special user such as
